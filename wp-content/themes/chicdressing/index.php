...
if ( is_home() ) {
	...
	<!-- NF : Modification niveau titre et ajout sous-titre -->
		<p class="chic-title">Dernières pièces</p>
		<h2 class="chic-subtitle">Nos dernières pièces de créateurs à prix cassés</h2>
		<?php
	...
	<!-- NF : Modification niveau titre et ajout sous-titre -->
	<p class="chic-title">La FashionMap - été 2022 </p>
	<h2 class="chic-subtitle">Découvrez les dernières tendances des marques de luxe</h2>
